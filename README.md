...
[README for English](https://github.com/takamichi-lab/j-spaw2/blob/main/README_en.md)
...
## 音声ファイルのダウンロード
[リンク](https://tmpuc.ent.box.com/file/2427356115617?sb=/activity) (zip, 9.1 GB)
...
- `jspaw2/`：音声ファイルのディレクトリ（上記URLよりダウンロードして使用してください）
...
* `_`：ASVspoof2021におけるメタデータと列数を合わせるための調整（各システムの入力に合わせて調整してください）
