...
class ConfigLA:
    ...
    def __init__(self):
        ...
        self.factor_1_list =  ['L1', 'L2',self.pooled_tag]
        ...
        self.factor_2_list = ['E1', 'E2', 'E3', 'E4', self.pooled_tag]
        self.factor_2_type = g_factor_type_both
        self.factor_2_tag_list = ['E1', 'E2', 'E3', 'E4',  self.pooled_tag]
        return
...
class ConfigPA:
    ...
    def __init__(self):
        ...
        self.p_names = ['spk', self.index_col, 'asv_room', 'asv_mic', 'dis_to_asv', 
                        'att_room', 'att_mic', 'att_d', 'att_to_spk', 
                        'att_pos', 'att_vol',  # ← ここを追加！ (p1, v1 の分)
                        'label', 'trim', 'subset']
        # name of data series for score file
        self.s_names = [self.index_col, self.score_col]
        ...
        # value of the factor to be considered
        self.factor_1_list =  [['R1', 'R2', 'R3', 'R4'], 
                               ['M1','M2','M3'], 
                               ['E1', 'E2', 'E3', 'E4'], 
                               [self.pooled_tag]]
        # type of the factor (spoofed only? bonafide only? or both)
        ...
        # 2nd group of factor
        self.factor_name_2 = ['att_room', 'att_mic', 'att_to_spk', 'att_d', 'att_pos', 'att_vol', 'dummy']
        
        # 修正2: p1, p2, v1, v2 を有効化（ここは元のままでOKですが、対応関係を確認）
        self.factor_2_list = [['r1', 'r2', 'r3', 'r4'],
                              ['m1', 'm2', 'm3'],
                              ['e1', 'e2', 'e3'],
                              ['s1','s2', 's3', 's4'],
                              ['p1','p2'],
                              ['v1','v2'],
                            # ['d1', 'd2', 'd3', 'd4', 'd5', 'd6'], # dis_to_asv は使わないのでコメントアウトのまま
                              [self.pooled_tag]] # dummy に対応

        self.factor_2_type = [g_factor_type_spoof, 
                              g_factor_type_spoof,
                              g_factor_type_spoof, 
                              g_factor_type_spoof,
                              g_factor_type_spoof,
                              g_factor_type_spoof,
                              g_factor_type_both]  # dummy (Pooled) 用
