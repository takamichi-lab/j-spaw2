...
- `protocols/`
    ...
    - ASV_eval_LA_L3.txt: 話者照合のためのトライアルリスト
      (なりすまし音声あり，本人同士：7,600ペア, 他人同士：30,000ペア, 本人同士の実発話となりすまし音声：16,000ペア)
    - ASV_eval_LA_L4.txt: 話者照合のためのトライアルリスト
      (なりすまし音声あり，本人同士：7,600ペア, 他人同士：30,000ペア, 本人同士の実発話となりすまし音声：16,000ペア)
    - ASV_eval_LA_L5.txt: 話者照合のためのトライアルリスト
      (なりすまし音声あり，本人同士：7,600ペア, 他人同士：30,000ペア, 本人同士の実発話となりすまし音声：16,000ペア)
    - ASV_LA_eval_tDCF.txt: tDCFを求めるためのリスト
    - ASV_PA_eval_tDCF.txt: tDCFを求めるためのリスト(本人同士：7,600ペア, 他人同士：30,000ペア, 本人同士の実発話となりすまし音声：640,000ペア) ※
    - PA_eval.txt: なりすまし音声検出のためのリスト(実発話：800ファイル, なりすまし音声：32,000ファイル)※
    - metadata_LA_L3.txt: LAタスク用のなりすまし音声のメタデータ(実発話：800ファイル, なりすまし音声：800ファイル)
    - metadata_LA_L4.txt: LAタスク用のなりすまし音声のメタデータ(実発話：800ファイル, なりすまし音声：800ファイル)
    - metadata_LA_L5.txt: LAタスク用のなりすまし音声のメタデータ(実発話：800ファイル, なりすまし音声：800ファイル)
